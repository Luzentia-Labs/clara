...
> **Affects:** packages/react/src/components/Button, packages/react/src/styles.css, packages/react/src/components/__tests__/matrix.test.tsx, packages/react/src/components/__tests__/primitives.test.tsx, packages/react/src/components/Button/verification.md, scripts/check-component-css.mjs, scripts/check-contrast.mjs
> **Points:** 5
...
The most-used control in the library. Its disabled state is where D0028 is decided in practice: aria-disabled keeps the explanation reachable.

...
> **Affects:** packages/react/src/components/Inline, packages/react/src/styles.css, packages/react/src/components/__tests__/matrix.test.tsx, packages/react/src/components/__tests__/primitives.test.tsx, packages/react/src/components/Inline/index.tsx, scripts/check-component-css.mjs
> **Points:** 1
...
Horizontal flow that wraps. Its gap doubles as adjacent-target spacing when the children are interactive (WCAG 2.5.8).

...
> **Affects:** packages/react/src/components/Card/**, packages/react/src/components/Card/index.tsx, scripts/check-component-css.mjs
> **Points:** 2

## User Story

**As a** Grace Adeyemi
**I want** a surface container with token-driven elevation
**So that** grouped content reads as one unit

## Acceptance Criteria

### AC1: Elevation is semantic

- **Given** a Card
- **When** it renders in dark theme
- **Then** elevation reads correctly where shadows barely register
- **Verify:** vitest "Card elevation reads in dark theme"
- **Verification target:** functional

### AC2: Token-only styling

- **Given** the Card stylesheet
...
- **Verify:** vitest "Card theme and density matrix"
- **Verification target:** functional
...
- **Verify:** file packages/react/src/components/Card/index.tsx
- **Verification target:** functional

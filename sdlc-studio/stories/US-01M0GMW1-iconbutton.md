...
> **Affects:** packages/react/src/components/IconButton, packages/react/src/styles.css, packages/react/src/components/__tests__/matrix.test.tsx, packages/react/src/components/IconButton/verification.md, scripts/check-component-css.mjs
> **Points:** 2
...
An icon-only button with no accessible name is the most common accessibility defect in an ERP toolbar, precisely because the control looks finished.

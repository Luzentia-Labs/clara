...
> **Affects:** packages/react/src/components/Box, packages/react/src/styles.css, packages/react/src/components/__tests__/matrix.test.tsx, packages/react/src/components/__tests__/primitives.test.tsx, packages/react/src/components/Box/index.tsx, scripts/api-report.mjs, scripts/check-component-css.mjs
> **Points:** 2
...
The layout primitive everything else composes from. Its spacing props are a closed set so they cannot drift off the density system.

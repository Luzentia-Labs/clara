...
> **Affects:** packages/react/src/components/Grid, packages/react/src/styles.css, packages/react/src/components/__tests__/matrix.test.tsx, packages/react/src/components/__tests__/primitives.test.tsx, packages/react/src/components/Grid/index.tsx, scripts/check-component-css.mjs
> **Points:** 2

## User Story

**As a** Sofia Marchetti
**I want** a token-constrained grid
**So that** dense form and dashboard layouts are consistent
...
A column grid. `columns` is a closed set because an ERP form uses a few column counts consistently, not an arbitrary number per screen.
...
### AC1: Columns and gaps are tokenised

- **Given** a Grid
- **When** I configure it
- **Then** column counts and gaps accept only token values
- **Verify:** shell npx vitest run packages/react/src/components/__tests__/matrix.test.tsx -t "Grid props are token-constrained"
- **Verified:** yes (2026-08-23)
- **Verification target:** functional

### AC2: Token-only styling

- **Given** the Grid stylesheet
...
- **Verify:** shell npx vitest run packages/react/src/components/__tests__/matrix.test.tsx -t "Grid theme and density matrix"
- **Verified:** yes (2026-08-23)
- **Verification target:** functional

### AC4: Definition of done

- **Given** the Grid story
- **When** it is proposed for export
- **Then** stories, tests, an axe assertion over default and error states, a visual baseline, a docs page all exist
- **Verify:** file packages/react/src/components/Grid/index.tsx
- **Verified:** yes (2026-08-23)
- **Verification target:** functional

...
- **Verify:** grep "debounce" apps/docs/src/content/components/search-input.md
- **Verification target:** functional
...
- **Verify:** vitest "SearchInput theme and density matrix"
- **Verification target:** functional
...
- **Verify:** file packages/react/src/components/SearchInput/verification.md
- **Verification target:** functional

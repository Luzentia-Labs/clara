...
> **Affects:** apps/docs/src/content/components/search-input.md, packages/react/src/components/SearchInput/SearchInput.tsx, packages/react/src/components/SearchInput/index.tsx, packages/react/src/components/SearchInput/verification.md, packages/react/src/components/SearchInput/verification.md, scripts/check-component-css.mjs
> **Points:** 2
...
- **Verify:** shell node scripts/check-verification.mjs --component SearchInput --docs && npx vitest run packages/react/src/components/Field/__tests__/behaviour.test.tsx -t "SearchInput imposes no delay of its own" --silent
- **Verified:** yes (2026-08-23)
- **Verification target:** functional
...
- **Verify:** shell node scripts/check-component-css.mjs --component SearchInput
- **Verified:** yes (2026-08-23)
- **Verification target:** functional
...
### AC5: Clear exists only when there is something to clear

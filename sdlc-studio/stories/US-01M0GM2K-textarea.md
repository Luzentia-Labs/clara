...
> **Affects:** packages/react/src/components/Textarea/**, packages/react/src/components/Textarea/verification.md
> **Points:** 3
...
- **Verify:** vitest "Textarea theme and density matrix"
- **Verification target:** functional
...
- **Verify:** file packages/react/src/components/Textarea/verification.md
- **Verification target:** functional

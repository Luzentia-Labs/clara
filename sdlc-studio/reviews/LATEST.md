...
- `pnpm check` runs **26 guards**; `prove-guards-fail` kills **79 mutations** on a staged copy.
...
- **81 decisions**. Stories: **31 Done of 88**. `main` is the only branch - this project is
  trunk-based.

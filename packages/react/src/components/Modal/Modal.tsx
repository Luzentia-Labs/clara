...
export const Modal = forwardRef<HTMLDivElement, ModalProps>(function Modal ({
  ...
  /**
   * Focus capture and restoration, shared with Drawer BY IDENTITY rather than by a copy.
   *
   * This was ~100 lines here, and every one of its comments records a defect measured across nine
   * adversarial review rounds. It moved to `lib/overlay-focus.ts` unchanged when Drawer needed the
   * same behaviour (US-01M0GMWW AC2): a second copy would inherit the code and not the reasons, and
   * the first person to simplify one of them would reintroduce a strand in one overlay and not the
   * other. Read that file for why any of it is shaped the way it is.
   */
